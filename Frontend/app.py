...
# Use an environment variable to decide which backend to hit
...
def team_vs_team():
    ...
    response = requests.get(f'{BACKEND_URL}/api/team_vs_team?team1={team1}&team2={team2}')
    response = response.json()

    response1 = requests.get(f'{BACKEND_URL}/api/teams')
